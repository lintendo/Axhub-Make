...
const WORKSPACE_PACKAGE_CHUNKS = new Map([
...
export function getPackageNameFromId(id) {
...
function startsWithPackageGroup(packageName, prefixes) {
...
export function getManualChunkName(id) {
    ...
    if (normalizedId.includes('/antd/dist/reset.css')
    ...
    if (ANTD_PACKAGES.has(packageName)
