...
function resolveVisitUrlHost(host) {
...
function normalizeOnlineBaseUrlOption(value, optionName) {
    try {
...
export function shouldAutoRunCli(argvPath = process.argv[1] || '', moduleUrl = import.meta.url, env = process.env) {
