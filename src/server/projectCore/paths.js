...
export function getMakeStateDir(projectRoot) {
    return path.join(resolveProjectRoot(projectRoot), MAKE_STATE_DIR);
}
export function getGlobalMakeStateDir(homeDir) {
...
export function getEntriesManifestPath(projectRoot) {
...
export function getGlobalAdminServerInfoPath(homeDir) {
