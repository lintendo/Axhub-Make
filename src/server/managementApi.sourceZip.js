...
import { sendFile, sendJson, streamDirectoryAsZip, } from './http.ts';
function resolveDirectoryFromResourceMetadata(context, resource) {
    const candidates = [
...
function normalizeLegacySourcePath(rawPath) {
...
function handleSourceAndZip(req, res, context, pathname, url) {
...
function handleProjectAwareSourceAndZip(req, res, options, pathname, url, handlers) {
...
export function handleProjectSourceAndZipApi(req, res, options, requestContext, pathname, url, handlers) {
