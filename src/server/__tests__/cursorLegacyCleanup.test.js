...
import { LEGACY_CURSOR_COMPANION_LABEL, LEGACY_CURSOR_WINDOWS_TASK_NAME, removeLegacyCursorIntegration, } from '../cursorLegacyCleanup.ts';
function fileSystemWith(...existing) {
