...
import { cleanupProjectApiTestRoots, createTempRoot, startTestServer, writeProjectMetadata, } from './projects-api.helpers.ts';
async function registerExisting(origin, root) {
...
describe('Make client project registration identity', () => {
    ...
    it('suffixes duplicate client ids and preserves independent project scopes', async () => {
        ...
        try {
            ...
            expect(list.projects.map((project) => project.id)).toEqual(['demo', 'demo-2', 'demo-3']);
